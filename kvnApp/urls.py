...
urlpatterns = [
    ...
    # path('tasks_status/',views.Tasks_status, name='Tasks_status'),
    path('tasks/', views.task_list, name='task_list'),  # List of available tasks
    path('tasks/accept/<str:task_id>/', views.accept_task, name='accept_task'),  # Accept task
    path('my-tasks/', views.user_tasks, name='user_tasks'),  # User's tasks page
